...
const Header = () => {
  ...
  const matchProductDetail = useMatch("/products/:id") && location.pathname !== PATH.productCreate;
  ...
  return (
    <div className="bg-black sticky top-0 w-full z-100 py-5 flex justify-between items-center  px-4 border-[#151B23] border-b">
       <div className="flex gap-3 items-center justify-center">
        <Button onClick={()=> navigate(-1)} textColor="black" bgColor="white" btnType="button" extraClass="p-0.5">
        <ChevronLeft />
        </Button>
       <h2 className="text-lg text-white  font-semibold tracking-wide">
        ...
        <Button  btnType="button"  onClick={()=> setLogModal(true)} bgColor="white" textColor="black" padX="6" padY="2">Log Out</Button>
        <Modal openModal={logModal} setOpenModal={setLogModal}>
          ...
          <Button  btnType="button"  onClick={()=> setLogModal(false)} bgColor="white" textColor="black" padY="2" padX="6">Cancel</Button>
          <Button  btnType="button"  onClick={()=> handleLogOut()} extraClass="bg-red-500" textColor="white" padX="6" padY="2">Log Out</Button>
