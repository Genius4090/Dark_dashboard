...
const Products = () => {
  ...
  return (
    <div className="container py-8">
     ...
     <input type="text"  className="border-[#3A3A3A] bg-[#1C1C1C] border py-1.5 px-4  placeholder:text-white outline-none text-white rounded" placeholder="Search..."/>
    ...
    <ul className="text-white flex flex-wrap gap-10 justify-center py-6">
      {products?.map(item=>
        <li key={item.id} className="w-[300px] h-[450px] p-2 rounded flex flex-col items-start justify-between">
          <img src="https://cdn.shopify.com/s/files/1/2303/2711/files/2_e822dae0-14df-4cb8-b145-ea4dc0966b34.jpg?v=1617059123" alt="product__img" />
